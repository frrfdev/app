...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    manualPrice: Schema.Attribute.Boolean;
    priceUnit: Schema.Attribute.Relation<'oneToOne', 'api::unit.unit'>;
    price: Schema.Attribute.Decimal;
    ingredients: Schema.Attribute.Component<'shared.ingredients', true>;
